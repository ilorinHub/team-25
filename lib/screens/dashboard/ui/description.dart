...
import 'package:machineglow/screens/dashboard/ui/finish.dart';
            ...
            child: Column(
              ...
              children: [
                const GlowThemeHeaderText(
                  title: 'Location',
                  description: 'Please choose the right location',
                ),
                ...
                const GlowThemeHeaderText(
                  title: 'Description of house',
                  description: 'Enter the description of the app below',
                ),
                VerticalSpacing((screenpadding)),
                DescriptionWidget(
                  ...
                  widget: GlowDropDownButton(
                      glowThemeData: glowthemeData,
                      multiList: viewmodel.buildingsAndTaxToShow.isNotEmpty
                          ? viewmodel.buildingsAndTaxToShow[0]
                          : [],
                      hintText: 'flat'),
                ),
                VerticalSpacing((screenpadding)),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(
                            _roomNo.toString(),
                            style: glowthemeData.textTheme().bodyMedium,
                          ),
                        ),
                        ...
                        AddOrMinusWidget(
                          ...
                          onTap: () {
                            setState(() {
                              _roomNo++;
                              taxPayable = taxPayable + 500;
                              _taxPayable.text = taxPayable.toString();
                            });
                          },
                        ),
                        const HorizontalSpacing(14),
                ...
                DescriptionWidget(
                  title: 'Tax payable',
                  widget: TextFieldWidget(
                      controller: _taxPayable,
                      isEnabled: false,
                      obscureText: false,
                      textInputAction: TextInputAction.done,
                      textInputType: TextInputType.number,
                      validator: (s) =>
                          UtilsHelpers.validateRequiredFields(s, label: ''),
                      hintText: ''),
                ),
                VerticalSpacing(screenpadding),
                SizedBox(
                    ...
                    onTap: () {
                      if (_formKey.currentState!.validate()) {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const CompleteUploadScreen()));
                      }
                    },
                  ),
                ),
